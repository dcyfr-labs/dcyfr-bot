...
export default defineConfig({
  ...
  // local macOS rendered / at 1440px as exactly 1743px tall — matching the
  // committed baseline — while CI rendered 1803px on three consecutive
  // attempts. Desktop is NOT immune; the drift was +60px here, +51px on
  // dcyfr-work, +20px on dcyfr-build.
  //
  ...
  use: {
    baseURL: process.env.BASE_URL ?? 'https://www.dcyfr.bot',
