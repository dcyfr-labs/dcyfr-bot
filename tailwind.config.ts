...
/**
 * dcyfr.bot Tailwind v3 config — semantic-var bridge.
 *
 * Maps CSS variables from `app/globals.css` into Tailwind utility classes
 * consumed across the site. Identity override lives in the
 * `.theme-dcyfr-bot` class (applied to `<html>`).
 *
 * @see docs/dcyfr-workspace/sites/dcyfr-bot.md for identity
 */
const config: Config = {
  darkMode: 'class',
  content: [
