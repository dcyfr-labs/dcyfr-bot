  ...
  return (
    <div className="bg-card/20 border border-border/30 rounded-xl overflow-hidden">
      <div className="bg-background/60 border-b border-border/40 px-4 py-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 text-xs text-muted-foreground">
        <span>
          <span className="font-medium text-foreground">You are chatting with an AI agent</span> — preview mode,
          read/search/web tools only
        </span>
      ...
      <div className="border-t border-border/40 px-4 py-2.5 text-xs text-muted-foreground">
        <p>
          Replies are generated by a large language model run by{' '}
          <a
          ...
          . Your message is sent to Anthropic to produce the reply. Output can be wrong or out of date — check
          anything you intend to rely on. Do not send personal, confidential, or client information. See our{' '}
      ...
      <div className="border-t border-border/40 p-3 flex gap-3 items-end">
        ...
        <button
          ...
          className="shrink-0 bg-primary hover:bg-primary/90 disabled:bg-muted disabled:text-muted-foreground text-primary-foreground font-medium px-4 py-2 rounded-lg text-sm transition-colors"
        >
          Send
        </button>
      </div>
